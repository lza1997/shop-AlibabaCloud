...
public class ZaTokenEndpoint {
	private static final String OAUTH_ACCESS = SecurityConstants.ZA_PREFIX + SecurityConstants.OAUTH_PREFIX + "auth_to_access:";
